...
unemployment_sales_effect = z_test_two_samples(df, 'Unemployment', 'Weekly_Sales', alpha = 0.05, variable1='unemployement', variable2='sales')
print(unemployment_sales_effect)
